using UnityEngine;
    ...
    {
        [SerializeField] private TargetSetting m_MazeTargetSetting;                                 // The script that tells the NavMeshAgent where to go.
        ...
        private void HandleTargetSet(Vector3 target)
        {
